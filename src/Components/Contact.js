  ...
  return (
    <div>
      <section id="contact" className='logos'>
        ...
        <img className='logoPics' alt="Themeforest logo" src="./media/themeforest.jpg" />
        <img className='logoPics' alt="Creative Market logo" src="./media/creative-market.jpg" />
      </section>
      <section className='contact'>
        <h3 className="contactTitle">CONTACT US</h3>
        <h5 className="contactDescription italic">Lorem ipsum dolor sit amet consectetur</h5>
        <form>
        ...
        <a className="button" href='#top'>Send Message</a>
      </section>
      <footer>
        <div className="footerContainer">
          ...
          <div className='socialContainer2'>
            ...
            <div className='socialBox'>
              <svg className="facebook" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
                <path
          ...
          <div className="bottomLinks">
            <a className="bottomLink">Privacy Policy</a>
            <a className="bottomLink">Terms of Use</a>
          </div>
        </div>
      </footer>
    </div>
